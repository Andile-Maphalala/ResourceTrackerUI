...
namespace ResourceTrackerUI.Features.BuildPlan
{
    public partial class EditInventoryItemModal
    {
        ...
        [Parameter] 
        public BuildPlanComponentModel Model { get; set; } = new();
        [Parameter] 
        ...
        private async Task Submit()
        {
            switch (FormMode)
            {
                case FormModeEnum.Create: 
                    await BuildPlanComponentService.CreateBuildPlanComponent(Model, appCancellation.Token); break;
                case FormModeEnum.Update: 
                    await BuildPlanComponentService.UpdateBuildPlanComponent(Model, appCancellation.Token); break;
                case FormModeEnum.Delete: 
                    await BuildPlanComponentService.DeleteBuildPlanComponent(Model.Id, appCancellation.Token); break;
            }
            MudDialog.Close();
        }
